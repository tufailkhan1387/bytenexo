...
<body>
    ...
    <!-- Service Start -->
    <div id="services" class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.5s">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
            ...
            <div class="row g-5">
                <div class="col-lg-7">
                    ...
                    <div class="d-flex align-items-center mt-2 wow zoomIn" data-wow-delay="0.6s">
                        ...
                        <div class="ps-4">
                            <h5 class="mb-2">Call to ask any question</h5>
                            <h4 class="text-primary mb-0">+92305-9566959</h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-5">
                ...
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.3s">
                    <div class="team-item bg-light rounded overflow-hidden">
                        <div class="team-img position-relative overflow-hidden" style="height: 400px">
                            <img class="img-fluid w-100" src="{{ asset('members/tufail.jpg') }}" alt="">
                        ...
                        <div class="text-center py-4">
                            <h4 class="text-primary">Tufail Khan</h4>
                            <p class="text-uppercase m-0">Full Stack Developer</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.6s">
                    <div class="team-item bg-light rounded overflow-hidden">
                        <div class="team-img position-relative overflow-hidden" style="height: 400px">
                            <img class="img-fluid w-100" src="{{ asset('members/abdullah.png') }}" alt="">
                            <div class="team-social">
                                {{-- <a class="btn btn-lg btn-primary btn-lg-square rounded" href=""><i class="fab fa-twitter fw-normal"></i></a>
                                <a class="btn btn-lg btn-primary btn-lg-square rounded" href=""><i class="fab fa-facebook-f fw-normal"></i></a>
                                <a class="btn btn-lg btn-primary btn-lg-square rounded" href=""><i class="fab fa-instagram fw-normal"></i></a> --}}
                        ...
                        <div class="text-center py-4">
                            <h4 class="text-primary">Abdullah Akram</h4>
                            <p class="text-uppercase m-0">Sr. Flutter Developer</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.9s">
                    <div class="team-item bg-light rounded overflow-hidden">
                        ...
                        <div class="text-center py-4">
                            <h4 class="text-primary">Hanan Iqbal</h4>
    ...
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                ...
                <h1 class="mb-0">Projects List</h1>
            </div>
            <div class="row g-5">
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.3s">
                    <div class="blog-item bg-light rounded overflow-hidden">
                        <div class="blog-img position-relative overflow-hidden">
                            <img height="200px" style="height: 200px !important" class="img-fluid" src="{{ asset('projects/pacifrica.png') }}" alt="">
                        ...
                        <div class="p-4">
                            ...
                            <h4 class="mb-3">Pacifrica Express</h4>
                            <p>Pacifica Express is an innovative and efficient project designed to streamline and
                               ...</p>
                ...
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.6s">
                    <div class="blog-item bg-light rounded overflow-hidden">
                        <div class="blog-img position-relative overflow-hidden">
                            <img height="200px" style="height: 200px !important" class="img-fluid" src="{{asset('projects/vincash.jpg')}}" alt="">
                            <a class="position-absolute top-0 start-0 bg-primary text-white rounded-end mt-5 py-2 px-4"
                                href="">Web App</a>
                        </div>
                        <div class="p-4">
                            ...
                            <h4 class="mb-3">Vincash Car Service</h4>
                            <p>VinCash is an online platform designed to facilitate the seamless buying...</p>
                            <a class="text-uppercase" href="">Read More <i class="bi bi-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.9s">
                    <div class="blog-item bg-light rounded overflow-hidden">
                        <div class="blog-img position-relative overflow-hidden">
                            <img height="200px" style="height: 200px !important" class="img-fluid" src="{{asset('projects/kwikie.png')}}" alt="">
                            <a class="position-absolute top-0 start-0 bg-primary text-white rounded-end mt-5 py-2 px-4"
                                href="">Mobile App</a>
                        </div>
                        <div class="p-4">
                            ...
                            <h4 class="mb-3">KwikieMart Food App</h4>
                    ...
                    <div class="row gx-5">
                        <div class="col-lg-4 col-md-12 pt-5 mb-5">
                            ...
                            <div class="d-flex mb-2">
                                ...
                                <p class="mb-0">Shabir Town , Lahore</p>
                            </div>
                            <div class="d-flex mb-2">
